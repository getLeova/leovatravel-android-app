...
/**
	 ...
	 * @returns {Function}
	 */
n.scrollSpy=function(r,u){var e=[],l,h;if(r=n(r),r.each(function(t,i){f.push(n(i));n(i).data("scrollSpy:id",t);n("a[href=#"+n(i).attr("id")+"]").click(function(t){t.preventDefault();var i=n(this.hash).offset().top+1;n("html, body").animate({scrollTop:i},{duration:400,queue:!1,easing:"easeOutCubic"})})}),u=u||{throttle:100},i.top=u.offsetTop||0,i.right=u.offsetRight||0,i.bottom=u.offsetBottom||0,i.left=u.offsetLeft||0,l=s(c,u.throttle||100),h=function(){n(document).ready(l)},!o){t.on("scroll",h);t.on("resize",h);o=!0}setTimeout(h,0);r.on("scrollSpy:enter",function(){e=n.grep(e,function(n){return n.height()!=0});var t=n(this);e[0]?(n("a[href=#"+e[0].attr("id")+"]").removeClass("active"),t.data("scrollSpy:id")<e[0].data("scrollSpy:id")?e.unshift(n(this)):e.push(n(this))):e.push(n(this));n("a[href=#"+e[0].attr("id")+"]").addClass("active")});r.on("scrollSpy:exit",function(){if(e=n.grep(e,function(n){return n.height()!=0}),e[0]){n("a[href=#"+e[0].attr("id")+"]").removeClass("active");var t=n(this);e=n.grep(e,function(n){return n.attr("id")!=t.attr("id")});e[0]&&n("a[href=#"+e[0].attr("id")+"]").addClass("active")}});return r};n.winSizeSpy=function(i){n.winSizeSpy=function(){return t};i=i||{throttle:100};return t.on("resize",s(l,i.throttle||100))};n.fn.scrollSpy=function(t){return n.scrollSpy(n(this),t)}})(jQuery),function(n){n(document).ready(function(){function s(i){var r=i.css("font-family"),u=i.css("font-size"),f;u&&t.css("font-size",u);r&&t.css("font-family",r);i.attr("wrap")==="off"&&t.css("overflow-wrap","normal").css("white-space","pre");t.text(i.val()+"\n");f=t.html().replace(/\n/g,"<br>");t.html(f);i.is(":visible")?t.css("width",i.width()):t.css("width",n(window).width()/2);i.css("height",t.height())}var r,t,o,f,u,i,e;Materialize.updateTextFields=function(){n("input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea").each(function(t,i){n(i).val().length>0||n(this).attr("placeholder")!==undefined||n(i)[0].validity.badInput===!0?n(this).siblings("label, i").addClass("active"):n(this).siblings("label, i").removeClass("active")})};r="input[type=text], input[type=password], input[type=email], input[type=url], input[type=tel], input[type=number], input[type=search], textarea";n("input[autofocus]").siblings("label, i").addClass("active");n(document).on("change",r,function(){(n(this).val().length!==0||n(this).attr("placeholder")!==undefined)&&n(this).siblings("label, i").addClass("active");validate_field(n(this))});n(document).ready(function(){Materialize.updateTextFields()});n(document).on("reset",function(t){var i=n(t.target);i.is("form")&&(i.find(r).removeClass("valid").removeClass("invalid"),i.find(r).each(function(){n(this).attr("value")===""&&n(this).siblings("label, i").removeClass("active")}),i.find("select.initialized").each(function(){var n=i.find("option[selected]").text();i.siblings("input.select-dropdown").val(n)}))});n(document).on("focus",r,function(){n(this).siblings("label, i").addClass("active")});n(document).on("blur",r,function(){var t=n(this);t.val().length===0&&t[0].validity.badInput!==!0&&t.attr("placeholder")===undefined&&t.siblings("label, i").removeClass("active");validate_field(t)});validate_field=function(n){var t=n.attr("length")!==undefined,i=parseInt(n.attr("length")),r=n.val().length;n.val().length===0&&n[0].validity.badInput===!1?n.hasClass("validate")&&(n.removeClass("valid"),n.removeClass("invalid")):n.hasClass("validate")&&(n.is(":valid")&&t&&r<i||n.is(":valid")&&!t?(n.removeClass("invalid"),n.addClass("valid")):(n.removeClass("valid"),n.addClass("invalid")))};t=n(".hiddendiv").first();t.length||(t=n('<div class="hiddendiv common"><\/div>'),n("body").append(t));o=".materialize-textarea";n(o).each(function(){var t=n(this);t.val().length&&s(t)});n("body").on("keyup keydown",o,function(){s(n(this))});n(".file-field").each(function(){var t=n(this).find("input.file-path");n(this).find('input[type="file"]').change(function(){t.val(n(this)[0].files[0].name);t.trigger("change")})});f="input[type=range]";u=!1;n(f).each(function(){var t=n('<span class="thumb"><span class="value"><\/span><\/span>');n(this).after(t)});e=".range-field";n(document).on("change",f,function(){var t=n(this).siblings(".thumb");t.find(".value").html(n(this).val())});n(document).on("mousedown touchstart",f,function(t){var r=n(this).siblings(".thumb"),f;r.length<=0&&(r=n('<span class="thumb"><span class="value"><\/span><\/span>'),n(this).append(r));r.find(".value").html(n(this).val());u=!0;n(this).addClass("active");r.hasClass("active")||r.velocity({height:"30px",width:"30px",top:"-20px",marginLeft:"-15px"},{duration:300,easing:"easeOutExpo"});i=t.pageX===undefined||t.pageX===null?t.originalEvent.touches[0].pageX-n(this).offset().left:t.pageX-n(this).offset().left;f=n(this).outerWidth();i<0?i=0:i>f&&(i=f);r.addClass("active").css("left",i);r.find(".value").html(n(this).val())});n(document).on("mouseup touchend",e,function(){u=!1;n(this).removeClass("active")});n(document).on("mousemove touchmove",e,function(t){var r=n(this).children(".thumb"),i,f;u&&(r.hasClass("active")||r.velocity({height:"30px",width:"30px",top:"-20px",marginLeft:"-15px"},{duration:300,easing:"easeOutExpo"}),i=t.pageX===undefined||t.pageX===null?t.originalEvent.touches[0].pageX-n(this).offset().left:t.pageX-n(this).offset().left,f=n(this).outerWidth(),i<0?i=0:i>f&&(i=f),r.addClass("active").css("left",i))});n(document).on("mouseout touchleave",e,function(){if(!u){var t=n(this).children(".thumb");t.hasClass("active")&&t.velocity({height:"0",width:"0",top:"10px",marginLeft:"-6px"},{duration:100});t.removeClass("active")}})});n.fn.material_select=function(t){n(this).each(function(){var e,u,o,i,h,f,s,r;if($select=n(this),!$select.hasClass("browser-default")){if(e=$select.data("select-id"),e&&($select.parent().find("i").remove(),$select.parent().find("input").remove(),$select.unwrap(),n("ul#select-options-"+e).remove()),t==="destroy"){$select.data("select-id",null).removeClass("initialized");return}u=Materialize.guid();$select.data("select-id",u);o=n('<div class="select-wrapper"><\/div>');o.addClass($select.attr("class"));i=n('<ul id="select-options-'+u+'" class="dropdown-content select-dropdown"><\/ul>');h=$select.children("option");f=$select.find("option:selected")!==undefined?$select.find("option:selected"):i.first();h.each(function(){i.append(n('<li class="'+(n(this).is(":disabled")?"disabled":"")+'"><span>'+n(this).html()+"<\/span><\/li>"))});i.find("li").each(function(i){var r=$select;n(this).click(function(){n(this).hasClass("disabled")||(r.find("option").eq(i).prop("selected",!0),r.trigger("change"),r.siblings("input.select-dropdown").val(n(this).text()),typeof t!="undefined"&&t())})});$select.wrap(o);s=n('<span class="caret">&#9660;<\/span>');$select.is(":disabled")&&s.addClass("disabled");r=n('<input type="text" class="select-dropdown" readonly="true" '+($select.is(":disabled")?"disabled":"")+' data-activates="select-options-'+u+'" value="'+f.html()+'"/>');$select.before(r);r.before(s);n("body").append(i);$select.is(":disabled")||r.dropdown({hover:!1});$select.attr("tabindex")&&n(r[0]).attr("tabindex",$select.attr("tabindex"));$select.addClass("initialized");r.on("focus",function(){n(this).trigger("open");f=n(this).val();selectedOption=i.find("li").filter(function(){return n(this).text().toLowerCase()===f.toLowerCase()})[0];activateOption(i,selectedOption)});r.on("blur",function(){n(this).trigger("close")});activateOption=function(t,i){t.find("li.active").removeClass("active");n(i).addClass("active");t.scrollTo(i)};filterQuery=[];onKeyDown=function(t){if(t.which==9){r.trigger("close");return}if(t.which==40&&!i.is(":visible")){r.trigger("open");return}if(t.which!=13||i.is(":visible")){t.preventDefault();letter=String.fromCharCode(t.which).toLowerCase();letter&&[9,13,27,38,40].indexOf(t.which)===-1&&(filterQuery.push(letter),string=filterQuery.join(""),newOption=i.find("li").filter(function(){return n(this).text().toLowerCase().indexOf(string)===0})[0],newOption&&activateOption(i,newOption));t.which==13&&(activeOption=i.find("li.active:not(.disabled)")[0],activeOption&&(n(activeOption).trigger("click"),r.trigger("close")));t.which==40&&(newOption=i.find("li.active").next("li:not(.disabled)")[0],newOption&&activateOption(i,newOption));t.which==27&&r.trigger("close");t.which==38&&(newOption=i.find("li.active").prev("li:not(.disabled)")[0],newOption&&activateOption(i,newOption));setTimeout(function(){filterQuery=[]},1e3)}};r.on("keydown",onKeyDown)}})}}(jQuery),function(n){var t={init:function(t){return t=n.extend({indicators:!0,height:400,transition:500,interval:6e3},t),this.each(function(){function l(n,t){n.hasClass("center-align")?n.velocity({opacity:0,translateY:-100},{duration:t,queue:!1}):n.hasClass("right-align")?n.velocity({opacity:0,translateX:100},{duration:t,queue:!1}):n.hasClass("left-align")&&n.velocity({opacity:0,translateX:-100},{duration:t,queue:!1})}function o(n){n>=r.length?n=0:n<0&&(n=r.length-1);i=f.find(".active").index();i!=n&&(e=r.eq(i),$caption=e.find(".caption"),e.removeClass("active"),e.velocity({opacity:0},{duration:t.transition,queue:!1,easing:"easeOutQuad",complete:function(){r.not(".active").velocity({opacity:0,translateX:0,translateY:0},{duration:0,queue:!1})}}),l($caption,t.transition),t.indicators&&s.eq(i).removeClass("active"),r.eq(n).velocity({opacity:1},{duration:t.transition,queue:!1,easing:"easeOutQuad"}),r.eq(n).find(".caption").velocity({opacity:1,translateX:0,translateY:0},{duration:t.transition,delay:t.transition,queue:!1,easing:"easeOutQuad"}),r.eq(n).addClass("active"),t.indicators&&s.eq(n).addClass("active"))}var u=n(this),f=u.find("ul.slides").first(),r=f.find("li"),i=f.find(".active").index(),e,s;i!=-1&&(e=r.eq(i));u.hasClass("fullscreen")||(t.indicators?u.height(t.height+40):u.height(t.height),f.height(t.height));r.find(".caption").each(function(){l(n(this),0)});r.find("img").each(function(){n(this).css("background-image","url("+n(this).attr("src")+")");n(this).attr("src","data:image/gif;base64,R0lGODlhAQABAIABAP///wAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==")});t.indicators&&(s=n('<ul class="indicators"><\/ul>'),r.each(function(){var u=n('<li class="indicator-item"><\/li>');u.click(function(){var u=f.parent(),e=u.find(n(this)).index();o(e);clearInterval($interval);$interval=setInterval(function(){i=f.find(".active").index();r.length==i+1?i=0:i+=1;o(i)},t.transition+t.interval)});s.append(u)}),u.append(s),s=u.find("ul.indicators").find("li.indicator-item"));e?e.show():(r.first().addClass("active").velocity({opacity:1},{duration:t.transition,queue:!1,easing:"easeOutQuad"}),i=0,e=r.eq(i),t.indicators&&s.eq(i).addClass("active"));e.find("img").each(function(){e.find(".caption").velocity({opacity:1,translateX:0,translateY:0},{duration:t.transition,queue:!1,easing:"easeOutQuad"})});$interval=setInterval(function(){i=f.find(".active").index();o(i+1)},t.transition+t.interval);var a=!1,h=!1,c=!1;u.hammer({prevent_default:!1}).bind("pan",function(n){var t;if(n.gesture.pointerType==="touch"){clearInterval($interval);var e=n.gesture.direction,i=n.gesture.deltaX,o=n.gesture.velocityX;$curr_slide=f.find(".active");$curr_slide.velocity({translateX:i},{duration:50,queue:!1,easing:"easeOutQuad"});e===4&&(i>u.innerWidth()/2||o<-.65)?c=!0:e===2&&(i<u.innerWidth()/-2||o>.65)&&(h=!0);h&&(t=$curr_slide.next(),t.length===0&&(t=r.first()),t.velocity({opacity:1},{duration:300,queue:!1,easing:"easeOutQuad"}));c&&(t=$curr_slide.prev(),t.length===0&&(t=r.last()),t.velocity({opacity:1},{duration:300,queue:!1,easing:"easeOutQuad"}))}}).bind("panend",function(n){n.gesture.pointerType==="touch"&&($curr_slide=f.find(".active"),a=!1,curr_index=f.find(".active").index(),c||h?h?(o(curr_index+1),$curr_slide.velocity({translateX:-1*u.innerWidth()},{duration:300,queue:!1,easing:"easeOutQuad",complete:function(){$curr_slide.velocity({opacity:0,translateX:0},{duration:0,queue:!1})}})):c&&(o(curr_index-1),$curr_slide.velocity({translateX:u.innerWidth()},{duration:300,queue:!1,easing:"easeOutQuad",complete:function(){$curr_slide.velocity({opacity:0,translateX:0},{duration:0,queue:!1})}})):$curr_slide.velocity({translateX:0},{duration:300,queue:!1,easing:"easeOutQuad"}),h=!1,c=!1,clearInterval($interval),$interval=setInterval(function(){i=f.find(".active").index();r.length==i+1?i=0:i+=1;o(i)},t.transition+t.interval))});u.on("sliderPause",function(){clearInterval($interval)});u.on("sliderStart",function(){clearInterval($interval);$interval=setInterval(function(){i=f.find(".active").index();r.length==i+1?i=0:i+=1;o(i)},t.transition+t.interval)})})},pause:function(){n(this).trigger("sliderPause")},start:function(){n(this).trigger("sliderStart")}};n.fn.slider=function(i){if(t[i])return t[i].apply(this,Array.prototype.slice.call(arguments,1));if(typeof i!="object"&&i)n.error("Method "+i+" does not exist on jQuery.tooltip");else return t.init.apply(this,arguments)}}(jQuery),function(n){n(document).ready(function(){n(document).on("click.card",".card",function(t){n(this).find(".card-reveal").length&&(n(t.target).is(n(".card-reveal .card-title"))||n(t.target).is(n(".card-reveal .card-title i"))?n(this).find(".card-reveal").velocity({translateY:0},{duration:225,queue:!1,easing:"easeInOutQuad",complete:function(){n(this).css({display:"none"})}}):(n(t.target).is(n(".card .activator"))||n(t.target).is(n(".card .activator i")))&&n(this).find(".card-reveal").css({display:"block"}).velocity("stop",!1).velocity({translateY:"-100%"},{duration:300,queue:!1,easing:"easeInOutQuad"}))})})}(jQuery),function(n){n(document).ready(function(){n.fn.pushpin=function(t){return t=n.extend({top:0,bottom:Infinity,offset:0},t),$index=0,this.each(function(){function i(n){n.removeClass("pin-top");n.removeClass("pinned");n.removeClass("pin-bottom")}function u(r,u){r.each(function(){t.top<=u&&t.bottom>=u&&!n(this).hasClass("pinned")&&(i(n(this)),n(this).css("top",t.offset),n(this).addClass("pinned"));u<t.top&&!n(this).hasClass("pin-top")&&(i(n(this)),n(this).css("top",0),n(this).addClass("pin-top"));u>t.bottom&&!n(this).hasClass("pin-bottom")&&(i(n(this)),n(this).addClass("pin-bottom"),n(this).css("top",t.bottom-e))})}var f=Materialize.guid(),r=n(this),e=n(this).offset().top;u(r,n(window).scrollTop());n(window).on("scroll."+f,function(){var i=n(window).scrollTop()+t.offset;u(r,i)})})}})}(jQuery),function(n){n(document).ready(function(){n.fn.reverse=[].reverse;n(document).on("mouseenter.fixedActionBtn",".fixed-action-btn",function(){var i=n(this);t(i)});n(document).on("mouseleave.fixedActionBtn",".fixed-action-btn",function(){var t=n(this);i(t)})});n.fn.extend({openFAB:function(){var i=n(this);t(i)},closeFAB:function(){i($this)}});var t=function(t){if($this=t,$this.hasClass("active")===!1){$this.addClass("active");$this.find("ul .btn-floating").velocity({scaleY:".4",scaleX:".4",translateY:"40px"},{duration:0});var i=0;$this.find("ul .btn-floating").reverse().each(function(){n(this).velocity({opacity:"1",scaleX:"1",scaleY:"1",translateY:"0"},{duration:80,delay:i});i+=40})}},i=function(n){$this=n;$this.removeClass("active");$this.find("ul .btn-floating").velocity("stop",!0);$this.find("ul .btn-floating").velocity({opacity:"0",scaleX:".4",scaleY:".4",translateY:"40px"},{duration:80})}}(jQuery),function(n){Materialize.fadeInImage=function(t){var i=n(t);i.css({opacity:0});n(i).velocity({opacity:1},{duration:650,queue:!1,easing:"easeOutSine"});n(i).velocity({opacity:1},{duration:1300,queue:!1,easing:"swing",step:function(t,i){i.start=100;var u=t/100,r=150-(100-t)/1.75;r<100&&(r=100);t>=0&&n(this).css({"-webkit-filter":"grayscale("+u+")brightness("+r+"%)",filter:"grayscale("+u+")brightness("+r+"%)"})}})};Materialize.showStaggeredList=function(t){var i=0;n(t).find("li").velocity({translateX:"-100px"},{duration:0});n(t).find("li").each(function(){n(this).velocity({opacity:"1",translateX:"0"},{duration:800,delay:i,easing:[60,10]});i+=120})};n(document).ready(function(){var t=!1,i=!1;n(".dismissable").each(function(){n(this).hammer({prevent_default:!1}).bind("pan",function(r){if(r.gesture.pointerType==="touch"){var u=n(this),e=r.gesture.direction,f=r.gesture.deltaX,o=r.gesture.velocityX;u.velocity({translateX:f},{duration:50,queue:!1,easing:"easeOutQuad"});e===4&&(f>u.innerWidth()/2||o<-.75)&&(t=!0);e===2&&(f<u.innerWidth()/-2||o>.75)&&(i=!0)}}).bind("panend",function(r){var u,f;Math.abs(r.gesture.deltaX)<n(this).innerWidth()/2&&(i=!1,t=!1);r.gesture.pointerType==="touch"&&(u=n(this),t||i?(f=t?u.innerWidth():-1*u.innerWidth(),u.velocity({translateX:f},{duration:100,queue:!1,easing:"easeOutQuad",complete:function(){u.css("border","none");u.velocity({height:0,padding:0},{duration:200,queue:!1,easing:"easeOutQuad",complete:function(){u.remove()}})}})):u.velocity({translateX:0},{duration:100,queue:!1,easing:"easeOutQuad"}),t=!1,i=!1)})})})}(jQuery),function(){Materialize.scrollFire=function(n){var t=!1;window.addEventListener("scroll",function(){t=!0});setInterval(function(){var u,r,e,o;if(t)for(t=!1,u=window.pageYOffset+window.innerHeight,r=0;r<n.length;r++){var i=n[r],s=i.selector,h=i.offset,c=i.callback,f=document.querySelector(s);f!==null&&(e=f.getBoundingClientRect().top+document.body.scrollTop,u>e+h&&i.done!==!0&&(o=new Function(c),o(),i.done=!0))}},100)}}(jQuery);
/*!
